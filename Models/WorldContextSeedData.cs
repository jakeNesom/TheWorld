...
namespace TheWorld.Models
{
    public class WorldContextSeedData
    {
        ...
        public async Task EnsureSeedData()
        {
            ...
            /*
                New Migrations - you have to comment out any seedData code if you want to initialize a 
                new migration in this project.  Something about seedData running before the command to 
                create a migration
             */
