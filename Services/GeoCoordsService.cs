...
namespace TheWorld.Services
{
    public class GeoCoordsService
    {
        ...
        public async Task<GeoCoordsResult> GetCoordsAsync(string name)
        {
            ...
            {
                // adding this 'failed result' so that if we do encounter a failure later
                // we don't have to create the failure then
                Success = false,
            ...
            //var url = $"http://dev.virtualearth.net/REST/v1/Locations?g={encodeName}&key={apiKey}";
